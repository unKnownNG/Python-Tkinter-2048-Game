...
class Game(Frame):
    ...
    def make_GUI(self):
        ...
        for i in range(4):
            ...
            for j in range(4):
                cell_frame = Frame(
                    self.main_grid, bg=c.EMPTY_CELL_COLOR, width=100, height=100
                )
        ...
        score_frame = Frame(self, bg="#14213d")
        ...
        self.score_label = Label(
            score_frame, text="0", bg="#14213d", fg=c.SCORE_FG, font=c.SCORE_FONT
        )
    ...
    def add_new_tile(self):
        ...
        while self.matrix[row][col] != 0:
            row = r.randint(0, 3)
            col = r.randint(0, 3)
        self.matrix[row][col] = r.choice([2, 4])
